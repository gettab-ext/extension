...
export const WP_CACHE_STORAGE_KEY = 'wp_cache_storage_key';
export const NEXT_WP_STORAGE_KEY = 'next_wp_storage_key';
export const LOCAL_WP_DIR = 'wallpapers';
export const RANDOM_WP_RENDERED = 'random-wp-rendered';
