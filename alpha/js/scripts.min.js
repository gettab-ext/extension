...
$(document).ready(function(){
	...
	$('#scroller_base').each(function(){
		$ScrollerWidth = 0;

		$(this).find('li').each(function(){
			$ScrollerWidth += $(this).outerWidth(true);
		})
		$(this).css('width', $ScrollerWidth)
	})
	...
	******************************************************/
//initial states ?? move to knockout
  ...
  //
	...
	******************************************************/
	...
	// 	$('input[name=' + $(this).find('input').attr('name') + ']').parent('.radio').removeClass('active');
	// 	$(this).find('input').prop('checked', true);
	// 	$(this).addClass('active');
  //   return true;
	// });
  //
	...
	$('.bodyBg').css('height', $windowHeight)
	$('.leftcol').css('height', $windowHeight)
	...
	/*	modal close
	******************************************************/
	$('.modal .close, .bodyBg').click( function(){
		$('.modal').removeClass('active');
		// $(this).parent('.wrapper').parent('.modal.active')removeClass('active');
	})
	/*	left menu
	******************************************************/
	...
	// $('.active#leftMenuSwitch').click( function(){
	// 	alert( 'click active');
	...
	/*	weather widget
	******************************************************/
	$('.weatherWidget').click( function(){
		$('.modal.active').removeClass('active');
		$('.weather_box').toggleClass('active');
	})

	$('.weather_box .links li').click(function(){
		$('.weather_box .links li').removeClass('active');
		$(this).addClass('active');
	})

	$('#settingsSw').click(function(){
		$('.weather_box').removeClass('active');
		$('.weather_box_settings').addClass('active');
	});

	$('.weather_box_settings .close').click(function(){
		$('.weather_box').addClass('active');
	})

	$('.search_city input[type=text]').keyup( function(){
		if ( $('.search_city input[type=text]').val() !='' ){
			$(this).parent('.search_city').find('ul').css('display', 'block');
		}
		else{
			$(this).parent('.search_city').find('ul').css('display', 'none');
		}
	})
	/*	gallerySw widget
	******************************************************/
	...
	/*	gallery favorites
	******************************************************/
	$('#scroller_base .fav').click(function(){
	...
	******************************************************/
	...
	$('.window_list div.active').each(function(){
		// $(this).parent('.window_list').parent('.gallery_box').css('height', $(this).outerHeight() );
		// console.log (  $(this).outerHeight()  );
	})
	$('#tb3 .btn').click( function(){
		$('.tab_list li').removeClass('active');
		$('.tab_list li[data-tab=tb1]').addClass('active');

		$('.window_list').find('div').removeClass('active');
		$('.window_list').find('div#tb1').addClass('active');
	})
